...
const Cart = () => {
    ...
    const cartProduct = products?.map(p => {
        ...
        return (
            <div className="cart__product" key={p._id}>
                ...
                <p className="cart__product-total">{p.price * p.amount - p.discount || p.price} сом</p>
                <div className="cart__product-delete" onClick={() => dispatch(deleteProduct(p._id))}>
